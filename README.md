# hüis (pronounced "who is") - a people list built in angular

Demo: https://huis-demo.herokuapp.com/
...
1. `npm run protractor` to run e2e tests (must have `npm start` running in another terminal)
